/**
 * 출처: blazejkustra/react-native-effects — example/src/components/BeerGlass.tsx
 * MIT License, Copyright (c) 2026 Blazej Kustra
 *
 * iBeer 재현 데모의 원본을 그대로 가져왔다. 맥주는 이 예제와 똑같이 보여야
 * 하므로 수식과 상수를 손대지 않는다. 다른 음료는 별도 파일에서 다룬다.
 */
